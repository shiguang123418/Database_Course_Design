...
class WinGUI(Window):
    ...
    def __tk_label_lx06b9ro(self, parent):
        label = Label(parent, text="搜索员工信息", anchor="center", bootstyle="default")
    ...
    def __tk_label_lxa2lnn7(self, parent):
        label = Label(parent, text="请输入员工编号：", anchor="center", bootstyle="default")
    ...
    def __tk_button_lxa2vxyp(self, parent):
        btn = Button(parent, text="搜索", takefocus=False, bootstyle="default")
