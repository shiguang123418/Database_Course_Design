...
class WinGUI(Window):
    ...
    def __tk_label_lxa2mi9r(self,parent):
        label = Label(parent,text="员工姓名：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2nm2i(self,parent):
        label = Label(parent,text="员工性别：",anchor="center", bootstyle="default")
    ...
    def __tk_label_lxa2nn7f(self,parent):
        label = Label(parent,text="员工年龄：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2nogk(self,parent):
        label = Label(parent,text="员工工龄：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2np4x(self,parent):
        label = Label(parent,text="身份证号：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2ntnc(self,parent):
        label = Label(parent,text="联系电话：",anchor="center", bootstyle="default")
        label.place(x=20, y=5, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2nuij(self,parent):
        label = Label(parent,text="入职日期：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2nv8i(self,parent):
        label = Label(parent,text="工资：",anchor="center", bootstyle="default")
