...
class WinGUI(Window):
    def __init__(self):
        ...
        self.tk_frame_lxa2nv8h = self.__tk_frame_lxa2nv8h(self)
        self.tk_label_lxa2nv8i = self.__tk_label_lxa2nv8i( self.tk_frame_lxa2nv8h)
        self.tk_input_lxa2nv8j = self.__tk_input_lxa2nv8j( self.tk_frame_lxa2nv8h)
    ...
    def __tk_label_lx06b9ro(self,parent):
        label = Label(parent,text="修改商品信息",anchor="center", bootstyle="default")
    ...
    def __tk_label_lxa2lnn7(self,parent):
        label = Label(parent,text="商品编号：",anchor="center", bootstyle="default")
    ...
    def __tk_label_lxa2mi9r(self,parent):
        label = Label(parent,text="商品销量：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2nm2i(self,parent):
        label = Label(parent,text="商品名称：",anchor="center", bootstyle="default")
    ...
    def __tk_label_lxa2nn7f(self,parent):
        label = Label(parent,text="商品类型：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2nogk(self,parent):
        label = Label(parent,text="商品售价：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2np4x(self,parent):
        label = Label(parent,text="商品成本：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2ntnc(self,parent):
        label = Label(parent,text="商品库存量：",anchor="center", bootstyle="default")
        label.place(x=20, y=5, width=146, height=30)
        return label
    ...
    def __tk_label_lxa2nuij(self,parent):
        label = Label(parent,text="计划库存量：",anchor="center", bootstyle="default")
        label.place(x=20, y=7, width=146, height=30)
        return label
    def __tk_input_lxa2nuik(self,parent):
        ...
        ipt.place(x=177, y=7, width=357, height=30)
        return ipt
    def __tk_frame_lxa2nv8h(self,parent):
        frame = Frame(parent,bootstyle="default")
        frame.place(x=30, y=433, width=549, height=42)
        return frame
    def __tk_label_lxa2nv8i(self,parent):
        label = Label(parent,text="供应商编号：",anchor="center", bootstyle="default")
        label.place(x=20, y=8, width=146, height=30)
        return label
    def __tk_input_lxa2nv8j(self,parent):
        ipt = Entry(parent, bootstyle="default")
        ipt.place(x=177, y=7, width=357, height=30)
        return ipt
...
class Win(WinGUI):
    ...
    def __event_bind(self):
        self.tk_button_lxa2vxyp.bind('<Button-1>',self.ctl.update_product)
    ...
    def __style_config(self):
        ...
        sty.configure(self.new_style(self.tk_label_lxa2mi9r),font=("微软雅黑",-12))
        ...
        sty.configure(self.new_style(self.tk_label_lxa2ntnc),font=("微软雅黑",-12))
        sty.configure(self.new_style(self.tk_label_lxa2nuij),font=("微软雅黑",-12))
        sty.configure(self.new_style(self.tk_label_lxa2nv8i),font=("微软雅黑",-12))
